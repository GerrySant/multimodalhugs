...
export CONFIG_PATH='/examples/multimodal_translation/Image2text_translation/configs/example_config.yaml'
export OUTPUT_PATH="/path/to/your/output_directory"
export CUDA_VISIBLE_DEVICES=0

# Ejecuta el script Python y captura sus salidas
output=$(python /examples/multimodal_translation/Image2text_translation/example_scripts/hebrew_training_setup.py \
