...
export CONFIG_PATH='/multimodalhugs/examples/multimodal_translation/pose2text_translation/configs/example_config.yaml'
export OUTPUT_PATH="/path/to/your/output_directory"
export CUDA_VISIBLE_DEVICES=0

# Ejecuta el script Python y captura sus salidas
output=$(python /examples/multimodal_translation/pose2text_translation/example_scripts/how2sign_training_setup.py \
